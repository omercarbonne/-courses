...
{
    char*  data;
    struct MarkoveNodeFrequencies * frequencies_list;
    int list_len;
}MarkovNode;

typedef struct MarkoveNodeFrequencies
{
...
/**
 * Free Node and all of it's content from memory
 ...
 * @param markov_node markov_node to free
 */
